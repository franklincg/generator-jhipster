...
import { getDefaultJDLDefinitions } from './jdl-runtime.ts';
import { getDefaultJDLApplicationConfig, getDefaultJDLDeploymentConfig } from './jhipster-jdl-config.ts';

describe('jdl runtime', () => {
  it('should expose the complete default definitions', () => {
    expect(getDefaultJDLDefinitions()).toEqual({
